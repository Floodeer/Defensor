...
public class Tower {
    ...
    @Getter Enums.TowerUltimate utimate;
    ...
    public class PlacedTower {
        ...
        private PlacedTower(Game game, Player owner, Location loc, Hologram hologram, Tower tower) {
            ...
            this.ultimate = tower.getUtimate();
            this.loc = loc;

            NPC npc = CitizensAPI.getNPCRegistry().createNPC(EntityType.PLAYER, displayName);
            npc.spawn(loc);

            this.entity = new TowerEntity(npc, getSkin(), true, hologram);
        }
    ...
    private class TowerEntity {
        ...
        public TowerEntity(NPC npc, String skin, boolean slim, Hologram hologram) {
